...
namespace RoadBook.CsharpBasic.Chapter02.Examples
{
    public class Ex006
    {
        public void Run()
        {
            ...
            Console.WriteLine("실수 : {0}, {1}, {2}", floatNumber, doubleNumber,
                decimalNumber);
            ...
            Console.WriteLine("{0}{1}{2}{3}{4}", strMessage[0], strMessage[1],
            ...
            Console.WriteLine("Hello Csharp 문장에 Hello가 포함되어 있다 ? ({0})",
            isContainsWord);
